            ...
            List {
                Group {
                    if nowPlayingState.movies != nil {
                        MoviePosterCarouselView(title: "Reproduciendo Ahora", movies: nowPlayingState.movies!)
                ...
                Group {
                    if topRatedState.movies != nil {
                        MovieBackdropCarouselView(title: "Más Valorados", movies: topRatedState.movies!)
